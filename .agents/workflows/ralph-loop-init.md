...
4. Check if `docs/prd.md` (Product Requirement Document) exists. If not, create it with a basic template containing:
   - Project Goal
   - Objectives
   - Acceptance Criteria
5. Check if `docs/progress.md` exists. If not, create it with an initial status indicating the start of the project.