...
4. Monitor the status of the session. This may involve periodically checking the session status using Jules CLI commands until it is marked as completed or failed. Wait at least a minute before check every time